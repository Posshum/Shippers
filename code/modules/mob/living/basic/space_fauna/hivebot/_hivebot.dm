...
/mob/living/basic/hivebot/core //slave to the system
	...
	"CANNON ARMED!!",
	"TARGET ACQUIRED!!",
	"EXECUTING ERADICATION PROTOCOL!!",
	"COMMENCING EXECUTION!!",
	"WEAPONS ARMED, ENGAGING COMBATANT!!",
	"TARGET ANALYSIS SHOWS WINNING ODDS!!",
	"MOTORS READY!!",
	"GYROSCOPIC STABILIZERS READY!!",
	"TARGET ACQUISITIONS READY!!",
	)
