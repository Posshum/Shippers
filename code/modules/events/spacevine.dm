...
####################*/
/datum/round_event_control/ship/spacevine
	name = "Space Vines"
	typepath = /datum/round_event/ship/spacevine
	weight = 5
...
/datum/round_event/ship/spacevine
	fakeable = FALSE
...
/datum/event_admin_setup/set_location/spacevine/apply_to_event(datum/round_event/ship/spacevine/event)
...
/datum/event_admin_setup/multiple_choice/spacevine/apply_to_event(datum/round_event/ship/spacevine/event)
