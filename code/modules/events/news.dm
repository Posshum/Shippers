GLOBAL_LIST_INIT(premade_news_stories, list(\
	...
	list("title" = "How could this happen?!", "msg" = "Breaking News: Reports on 'Sapient Bread' have been discovered. A recent study on the effects of Bluespace Technology interacting with organic matter has found that occasionally, Bread may turn into a more sentient form of its previous self. Studies show that this new phenomenon is to be a worry for travelers in space, as teleportation is a common use for many ships involved with inter-stellar travel. Be sure to keep your bread safe, and don't leave it out, or you may get a new passenger on board!"),\
	list("title" = "RE: How do I use the newscaster?", "msg" = "Hey Gerald! I'm really glad you got me onto the news team, but I have one question. How do I even start producing news articles for people to read? Thanks. - \"Cory\" "),\
	list("title" = "Test Messaging System", "msg" = "This is an automatic test messaging system. If you have recieved this message, have a good day!"),\
	))
