#define RANDOM_EVENT_ADMIN_INTERVENTION_TIME (60 SECONDS)
...
/datum/round_event_control
	...
	var/max_occurrences = INFINITY //The maximum number of times this event can occur (naturally), it can still be forced.
...
/datum/round_event_control/proc/prerun_event()
