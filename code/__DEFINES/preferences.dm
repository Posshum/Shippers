...
#define SOUND_DYNAMIC_MUSIC (2<<0) //Had to start at 2<<0 cuz 1<<24 didn't work...
#define SOUND_COMBAT_MUSIC (2<<1)
#define COMBAT_FEAR (2<<2)

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|SOUND_ENDOFROUND|SOUND_RADIO|SOUND_DYNAMIC_MUSIC|SOUND_COMBAT_MUSIC|MEMBER_PUBLIC|INTENT_STYLE|COMBAT_FEAR|MIDROUND_ANTAG|SOUND_INSTRUMENTS|SOUND_PRAYERS|SOUND_ANNOUNCEMENTS)
