...
#define SOUND_DYNAMIC_MUSIC (1<<23)

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|SOUND_ENDOFROUND|SOUND_RADIO|SOUND_DYNAMIC_MUSIC|MEMBER_PUBLIC|INTENT_STYLE|MIDROUND_ANTAG|SOUND_INSTRUMENTS|SOUND_PRAYERS|SOUND_ANNOUNCEMENTS)
