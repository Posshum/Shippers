...
.hypnophrase			{color: #3bb5d3;	font-weight: bold;	animation: hypnocolor 1500 infinite; animation-direction: alternate;}
...
.phobia			{color: #dd0000;	font-weight: bold;	animation: phobia 750 infinite;}
	keyframes phobia {
		0%		{color: #0d0d0d;}
		50%		{color: #dd0000;}
		100%	{color: #0d0d0d;}
